<template>
    <div class="bg-[#1a1b1e] min-h-screen text-white">
      <div class="p-4">
        <!-- Header -->
        <div class="flex items-center justify-between mb-6">
          ...
          <div class="flex items-center space-x-4">
            ...
            <button class="bg-[#25262b] p-2 rounded-md">
  ...
  export default {
    ...
    methods: {
      ...
      openDashboard(user) {
        // Navigate to Dashboard.vue. Adjust route name/params as required.
        // For example, if Dashboard route is named 'dashboard' and expects a user id:
