    ...
    <div class="flex-1 flex flex-col">
      <main class="p-6">
        ...
        <div class="grid grid-cols-12 gap-5 pb-5" v-if="!loading">
          <DashCard title="참가자 수" :description="dashCardData.participants" />
          <DashCard title="평균 성장률" :description="dashCardData.improvementPercentage + '%'" />
          <DashCard title="선택 교육 과정" :description="dashCardData.selectedCourse" />
            ...
            <div class="col-span-12 md:col-span-12 lg:col-span-7">
              <div class="shadow p-4 rounded-border border border-gray-600 rounded-lg max-h-120 relative">
                <div class="flex flex-col gap-2">
                  <span class="block text-surface-500 dark:text-surface-300 font-medium">남성, 여성 리더십 비교</span>
                  <div class="w-full">
                    <p class="text-sm text-gray-700 mb-4 truncate">남성, 여성 리더십 비교</p>
                  </div>
